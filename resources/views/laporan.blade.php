                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            <div class="text-center mb-4">
                                <h6 class="mb-4">CABANG</h6>
                                <div class="d-flex flex-column">
                                    <a href="{{route ('laporancabang')}}">
                                        <button type="button" class="btn btn-outline-secondary m-2">ASDAQ KITCHEN 1</button>
                                    </a>
                                    <a href="{{route ('laporancabang')}}">
                                        <button type="button" class="btn btn-outline-secondary m-2">ASDAQ KITCHEN 2</button>
                                    </a>
                                    <a href="{{route ('laporancabang')}}">
                                        <button type="button" class="btn btn-outline-secondary m-2">ASDAQ KITCHEN 3</button>
                                    </a>
                                </div>
                            </div>
                        </div> 
