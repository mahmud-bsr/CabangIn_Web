                        ...
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <form>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="username" class="form-control" aria-label="Disabled input example" 
                                        disabled readonly id="inputUsername3"
                                        placeholder="Mahmud01">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="inputEmail3" class="col-sm-2 col-form-label">Email</label>
                                    <div class="col-sm-10">
                                        <input type="email" class="form-control" aria-label="Disabled input example" 
                                        disabled readonly id="inputEmail3"
                                        placeholder="mahmud01@gmail.com">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="inputTelp3" class="col-sm-2 col-form-label">Telp</label>
                                    <div class="col-sm-10">
                                        <input type="telp" class="form-control" aria-label="Disabled input example" 
                                        disabled readonly id="inputTelp3"
                                ...
                                <a href ="{{route ('editprofil')}}"><button type="button" class="btn btn-primary m-2">Edit</button></a>
                                <a href ="{{route ('changepassword')}}"><button type="button" class="btn btn-outline-info m-2 ">Change Password</button></a>
                                </div>
                            </form>
                        </div>
                    </div>
