                ...
                <div class="row h-79 align-items-center justify-content-center" style="min-height: 79vh;">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <h6 class="mb-4">ADD CABANG</h6>
                            </div>
                            <form>
                                <div class="row mb-3">
                                    <label for="inputNamaCabang3" class="col-sm-2 col-form-label">Nama Cabang</label>
                                    <div class="col-sm-10">
                                        <input type="namacabang" class="form-control" id="inputNamaCabang3"
                                        placeholder="Masukkan Nama Cabang">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="inputLokasi3" class="col-sm-2 col-form-label">Lokasi</label>
                                    <div class="col-sm-10">
                                        <input type="lokasi" class="form-control" id="inputLokasiCabang3"
                                ...
                                <a href ="{{route ('cabang')}}"><button type="button" class="btn btn-secondary m-2">Add</button></a>
                                <a href ="{{route ('cabang')}}"><button type="button" class="btn btn-danger m-2">Cancel</button></a>
                                </div>
                            </form>
                        </div>
                    </div>
