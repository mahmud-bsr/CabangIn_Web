                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <form>
                                ...
                                <a href ="{{route ('profiladmin')}}"><button type="button" class="btn btn-primary m-2">Edit</button></a>
                                <a href ="{{route ('profiladmin')}}"><button type="button" class="btn btn-danger m-2">Cancel</button></a>
                                </div>
                            </form>
                        </div>
                    </div>
