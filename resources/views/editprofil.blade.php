                ...
                <div class="navbar-nav align-items-center ms-auto">
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
                            ...
                            <a href="{{route ('signin')}}l" class="dropdown-item">Log Out</a>
                        </div>
                    </div>
                </div>
            </nav>
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <form>
                                ...
                                <a href ="{{route ('profiluser')}}"><button type="button" class="btn btn-primary m-2">Edit</button></a>
                                <a href ="{{route ('profiluser')}}"><button type="button" class="btn btn-danger m-2">Cancel</button></a>
                                </div>
                            </form>
                        </div>
                    </div>
