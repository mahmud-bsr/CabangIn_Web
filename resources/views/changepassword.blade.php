                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <form>
                                ...
                                <div class="row mb-3">
                                    <label for="inputPasswordBaru3" class="col-sm-2 col-form-label">Password Baru</label>
                                    <div class="col-sm-10">
                                        <input type="passwordbaru" class="form-control" id="inputPasswordBaru3"
                                ...
                                <a href ="{{route ('profiluser')}}"><button type="button" class="btn btn-success m-2">Save</button></a>
                                </div>
                            </form>
                        </div>
                    </div>
