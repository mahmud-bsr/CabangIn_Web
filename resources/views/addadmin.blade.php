                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <form>
                                ...
                                <a href ="{{route ('admin')}}"><button type="button" class="btn btn-secondary m-2">Add</button></a>
                                <a href ="{{route ('admin')}}"><button type="button" class="btn btn-danger m-2">Cancel</button></a>
                                </div>
                            </form>
                        </div>
                    </div>
