                        ...
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    <tr>
                                        <th scope="row">1</th>
                                        <td>Rendy Ardhitya</td>
                                        <td>Paiton</td>
                                        <td><a class="btn btn-sm btn-primary" href="{{route ('profiladmin')}}">Detail</a></td>
                                    </tr>
                                    <tr>
                                        <th scope="row">2</th>
                                        <td>Kurniawan Putra</td>
                                        <td>Kraksan</td>
                                        <td><a class="btn btn-sm btn-primary" href="{{route ('profiladmin')}}">Detail</a></td>
                                    </tr>
                                    <tr>
                            ...
                            <a href ="{{route ('addadmin')}}"><button type="button" class="btn btn-secondary m-2">ADD</button></a>
                            </div>
                        </div>
                    </div>
                </div>
